        ...
        <footer className="bg-gray-900 text-gray-300">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div>
                        <h3 className="text-white font-semibold mb-4 text-lg">Listen On</h3>
                        <div className="space-y-3">
                            ...
                            >
                                ...
                                <span className="text-gray-300 group-hover:text-white font-medium">YouTube</span>
                            </a>
                            <a
                            ...
                            >
                                ...
                                <span className="text-gray-300 group-hover:text-white font-medium">Apple Podcasts</span>
                            </a>
                            <a
                            ...
                            >
                                ...
                                <span className="text-gray-300 group-hover:text-white font-medium">Amazon Music</span>
                            </a>
                            <a
                            ...
                            >
                                ...
                                <span className="text-gray-300 group-hover:text-white font-medium">Audible</span>
                            </a>
                            <a
                            ...
                            >
                                ...
                                <span className="text-gray-300 group-hover:text-white font-medium">SoundCloud</span>
                            </a>
                            <a
                            ...
                            >
                                ...
                                <span className="text-gray-300 group-hover:text-white font-medium">Spotify</span>
                            </a>
                        </div>
                    </div>
                </div>
