            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    ...
                    <div className="col-span-1">
                        ...
                        <p className="text-gray-400 max-w-md text-justify leading-relaxed text-base">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <Link to="/" className="text-gray-300 hover:text-white transition-colors text-base font-medium">
                                    Home
                                </Link>
                            </li>
                            <li>
                                <Link to="/blog" className="text-gray-300 hover:text-white transition-colors text-base font-medium">
                                    Blog
                                </Link>
                            </li>
                            <li>
                                <Link to="/contact" className="text-gray-300 hover:text-white transition-colors text-base font-medium">
                                    Contact
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div>
                        <h3 className="text-white font-bold mb-6 text-xl">Listen On</h3>
                        <div className="space-y-4">
                            <a
                                href={PLATFORM_URLS.youtube}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center space-x-4 px-4 py-3 rounded-xl hover:bg-gray-800 transition-all duration-300 group"
                            >
                                ...
                                <span className="text-gray-300 group-hover:text-white font-semibold text-base">YouTube</span>
                            </a>
                            <a
                                ...
                                className="flex items-center space-x-4 px-4 py-3 rounded-xl hover:bg-gray-800 transition-all duration-300 group"
                            >
                                <div className="w-12 h-12 rounded-full bg-purple-600 flex items-center justify-center flex-shrink-0 shadow-lg">
                                    <svg className="w-7 h-7 text-white" viewBox="0 0 24 24" fill="currentColor">
                                ...
                                <span className="text-gray-300 group-hover:text-white font-semibold text-base">Apple Podcasts</span>
                            </a>
                            <a
                            ...
                            >
                                ...
                                <span className="text-gray-300 group-hover:text-white font-semibold text-base">Amazon Music</span>
                            </a>
                            <a
                            ...
                            >
                                ...
                                <span className="text-gray-300 group-hover:text-white font-semibold text-base">Audible</span>
                            </a>
                            <a
                                ...
                                className="flex items-center space-x-4 px-4 py-3 rounded-xl hover:bg-gray-800 transition-all duration-300 group"
                            >
                                <div className="w-12 h-12 rounded-full bg-orange-600 flex items-center justify-center flex-shrink-0 shadow-lg">
                                    <svg className="w-7 h-7 text-white" viewBox="0 0 24 24" fill="currentColor">
                                ...
                                <span className="text-gray-300 group-hover:text-white font-semibold text-base">SoundCloud</span>
                            </a>
                            <a
                            ...
                            >
                                ...
                                <span className="text-gray-300 group-hover:text-white font-semibold text-base">Spotify</span>
                            </a>
                        </div>
                    </div>
                </div>
